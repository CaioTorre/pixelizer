...
if size_out != -1:
    ...
    if size_out == 1:
        imageio.imwrite(image_path[0:-4]+'_'+repr(pixel_width)+'x'+repr(pixel_height)+'_small_flat.png', image_out)
    else:
        imageio.imwrite(image_path[0:-4]+'_'+repr(pixel_width)+'x'+repr(pixel_height)+'_big_flat.png', image_out)
